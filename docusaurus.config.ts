...
const config: Config = {
  title: 'Architecture Blueprint System',
  tagline: 'Enterprise Architecture Documentation and Visualization',
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      logo: {
        alt: 'Architecture Blueprint Logo',
        src: 'img/logo.svg',
      },
      items: [
        {
    ...
    footer: {
      style: 'dark',
      copyright: `Copyright ${new Date().getFullYear()} Enterprise Architecture Blueprint`,
    },
    prism: {
